...
from models import (
    ResearchFindings, AcademicSource, ArticleOutput, ArticleSection,
    TavilySearchResult, TavilySearchResponse
)
from tools import TavilyClient, TavilyAPIError
...
def test_models():
    ...
    try:
        ...
        findings = ResearchFindings(
            ...
            research_summary="Comprehensive research summary " * 10,  # Make it long enough
        ...
        section = ArticleSection(
            ...
            content="Machine learning is a fascinating field... " * 50  # Make it long enough
        )
