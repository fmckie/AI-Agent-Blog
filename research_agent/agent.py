...
from models import ResearchFindings, AcademicSource, TavilySearchResponse
...
def create_research_agent(config: Config) -> Agent[None, ResearchFindings]:
    ...
    @research_agent.tool
    def identify_research_gaps_tool(ctx: RunContext[None], sources: List[Dict[str, Any]] = None) -> List[str]:
        """
...
async def run_research_agent(
    ...
    try:
        ...
        # Extract the data from AgentRunResult
