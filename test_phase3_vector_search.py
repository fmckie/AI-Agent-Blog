...
class Phase3Tester:
    ...
    async def test_1_basic_crud(self) -> bool:
        ...
        try:
            ...
            result = self.supabase.table("research_findings").insert(test_finding).execute()
            ...
            result2 = self.supabase.table("research_sources").insert(test_source2).execute()
    ...
    async def test_2_vector_operations(self) -> bool:
        ...
        try:
            ...
            result = self.supabase.table("content_chunks").select("*").eq("source_id", source_id).execute()
            ...
            result = self.supabase.table("embedding_queue").insert(queue_entry).execute()
    ...
    async def test_3_semantic_search(self) -> bool:
        ...
        try:
            ...
            result_filtered = self.supabase.rpc("search_similar_chunks", {
                "query_embedding": query_embedding,
                "match_threshold": 0.0,
                "match_count": 10,
            ...
            if source_ids:
                result = self.supabase.rpc("find_related_sources", {
    ...
    async def test_4_performance_metrics(self) -> bool:
        ...
        try:
            ...
            result = self.supabase.rpc("calculate_optimal_lists", {
    ...
    def cleanup_test_data(self, source_ids: List[str], finding_ids: List[str]):
        ...
        try:
            ...
            if source_ids:
                self.supabase.table("research_sources").delete().in_("id", source_ids).execute()
            
            # Delete findings
            if finding_ids:
                self.supabase.table("research_findings").delete().in_("id", finding_ids).execute()
    ...
    async def run_all_tests(self):
        ...
        print(f"{Fore.YELLOW}Running comprehensive tests on Supabase vector storage...{Style.RESET_ALL}\n")
