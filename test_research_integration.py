...
async def test_research_agent_integration():
    ...
    with patch.object(agent, 'run') as mock_run:
        mock_run.return_value = mock_findings
...
async def test_error_handling():
    ...
    low_source_findings = ResearchFindings(
        ...
        main_findings=["Limited data available", "Emerging field of study", "Requires further investigation"],
    ...
    with patch.object(agent, 'run', return_value=low_source_findings):
