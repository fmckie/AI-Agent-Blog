...
async def test_research_only():
    ...
    try:
        ...
        if storage:
            ...
            for source in sources:
                ...
                if url:
                    ...
                    if source_data:
                        stored_count += 1
                        print(f"{Fore.GREEN}✓ Stored: {source.get('title', '')[:60]}...{Style.RESET_ALL}")
            ...
            for source in sources[:3]:
                ...
                if url:
                    ...
                    if hierarchy and hierarchy.get('children'):
                        ...
                        print(f"- Found {len(hierarchy['children'])} crawled pages from {url}")
        ...
        if storage:
            ...
            print(f"{Fore.GREEN}✓ Sources Stored: {stored_count}/{len(sources)}{Style.RESET_ALL}")
