...
from models import ResearchFindings, AcademicSource, ArticleOutput, ArticleSection
...
def mock_research_findings():
    ...
    return ResearchFindings(
        ...
        research_summary="AI is transforming various industries with significant improvements in efficiency and accuracy.",
        academic_sources=[
            AcademicSource(
        ...
        research_gaps=["Long-term impact studies needed", "More research on AI bias required"],
...
def sample_article_content():
    ...
    return """
    <h1>Artificial Intelligence: Transforming Our Future</h1>
...
class TestWriterTools:
    ...
    def test_check_seo_requirements(self, sample_article_content):
        ...
        title = "Artificial Intelligence: Transforming Our Future"
        ...
        results = check_seo_requirements(ctx, title, meta, sample_article_content, keyword)
...
class TestWriterUtilities:
    ...
    def test_extract_headers_structure(self, sample_article_content):
        ...
        assert any(h["text"] == "Artificial Intelligence: Transforming Our Future" for h in headers)
    ...
    def test_analyze_keyword_placement(self, sample_article_content):
        ...
        analysis = analyze_keyword_placement(sample_article_content, "artificial intelligence")
...
class TestWriterAgent:
    ...
    async def test_run_writer_agent_success(self, test_config, mock_research_findings):
        ...
        expected_article = ArticleOutput(
            ...
            introduction="Artificial intelligence is revolutionizing the way we live and work...",
            main_sections=[
                ArticleSection(
                    heading="Understanding AI Technology",
                    content="Artificial intelligence encompasses machine learning..." + " test" * 100
                ),
                ArticleSection(
            ...
            conclusion="The future of artificial intelligence is bright...",
            word_count=1200,
        ...
        mock_result = Mock()
        mock_result.data = expected_article
        
        with patch.object(agent, 'run', return_value=mock_result):
            result = await run_writer_agent(agent, "artificial intelligence", mock_research_findings)
    ...
    @pytest.mark.asyncio
    async def test_run_writer_agent_no_sources(self, test_config, mock_research_findings):
        ...
        bad_article = ArticleOutput(
            title="Test Article",
            meta_description="Test meta description for the article about testing.",
            focus_keyword="test",
            introduction="Test introduction" * 20,
            main_sections=[
                ArticleSection(
...
class TestWriterAgentIntegration:
    ...
    async def test_writer_agent_with_real_api(self, test_config, mock_research_findings):
